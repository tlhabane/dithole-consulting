...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $phone 	    = sanitizeString($input_data->phone);
    ...
    if(!empty($email)){
        ...
        $header		= '<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head><body style="margin: 0; padding: 15px; background-color: #ffffff; font-family: Tahoma, Geneva, sans-serif; font-size: 14px; color: #525252; line-height: 17px;"><p><a href="'. SITE_ROOT .'"><img src="' . SITE_LOGO . '" /></a></p>';
        ...
        $mail_subject = empty($project) || trim(strtolower($project)) === 'select project type' ? MAIL_SUBJECT : $project;
