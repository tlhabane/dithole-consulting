    ...
    <div className="bg-white">
      ...
      <div className="w-full h-[400px] bg-slate-200 relative">
        ...
        <div className="w-full h-full flex items-center justify-center bg-slate-300">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3593.3242962127415!2d28.1925959!3d-25.759849900000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e95623ceb25ca21%3A0x45d754decfaaef7d!2s596%20Thabo%20Sehume%20St%2C%20Pretoria%20Central%2C%20Pretoria%2C%200002!5e0!3m2!1sen!2sza!4v1765568721594!5m2!1sen!2sza"
                width="100%" height="100%" style={{ border:0, height: '100%', width: '100%'}} allowFullScreen="" loading="lazy"
                ...
                <div className="bg-slate-900 p-10 text-white flex flex-col justify-center relative overflow-hidden">
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-start group">
                            <div
                                className="bg-slate-800 p-3 rounded-lg mr-4 group-hover:bg-cyan-900/50 transition duration-300 border border-slate-700 group-hover:border-cyan-500/30">
                                <MapPin className="text-cyan-400" size={24}/>
                            </div>
                            <div>
                                <h4 className="font-heading text-2xl font-bold text-white">Our Location</h4>
                                <p className="font-sans text-slate-300">596 Thabo Sehume, Motown Fountains<br/>Pretoria,
                                    0002</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                ...
                                <p className="font-sans text-slate-300">+27 78 158 8658</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                ...
                                <p className="font-sans text-cyan-400/80 text-sm italic mt-1">24/7 Support for IT
                                    Clients</p>
                            </div>
                        </div>
                    </div>
